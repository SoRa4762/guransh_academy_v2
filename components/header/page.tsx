...
const Header = (props: Props) => {
  ...
  return (
    <>
      ...
      <div className="h-[10vh] sm:h-[12vh] w-full flex justify-between items-center px-6 md:px-16 relative bg-gray-100 shadow-md shadow-gray-500">
        <div className="flex items-center">
          ...
          <p className="sm:hidden flex ml-4 font-semibold text-lg">
            Guransh Academy
          </p>
        </div>
